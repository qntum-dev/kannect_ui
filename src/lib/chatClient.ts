...
export const Local: BaseURL = "https://kannect-10.onrender.com"

/**
 * Environment returns a BaseURL for calling the cloud environment with the given name.
 */
export function Environment(name: string): BaseURL {
    return `https://kannect-10.onrender.com`
}
...
/**
 * Client is an API client for the rzprw Encore application.
 */
export default class Client {
    public readonly newChat: newChat.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.newChat = new newChat.ServiceClient(base)
    }
}
...
export namespace newChat {
    ...
    export interface ChatListStreamReq {
        "chat_id": string
        receiverId: string
        receiverName: string
        latestMessage: string | null
    ...
    export interface ChatListStreamRes {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof globalThis === "object" && !("window" in globalThis)) {
            this.headers["User-Agent"] = "rzprw-Generated-TS-Client (Encore/v1.46.16)";
        }
